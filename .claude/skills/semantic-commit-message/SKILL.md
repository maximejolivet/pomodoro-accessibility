...
- **emoji**: the one from the table below for the type, placed right after the colon and followed by a space. It counts toward the 72 characters.
...
| `refactor` | ♻️ | Restructure code, no behavior change |
...
refactor(settings): ♻️ extract preset editor into its own component
